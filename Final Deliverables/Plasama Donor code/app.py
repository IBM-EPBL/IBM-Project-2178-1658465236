...
myconn=ibm_db.connect('DATABASE=bludb;HOSTNAME=125f9f61-9715-46f9-9399-c8177b21803b.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=30426;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=hhd42917;PWD=3I3ZwPXnGozXnM5c', '', '')
@app.route("/signup")
def signup():
